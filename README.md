...
|||||
| 16 | Azure Machine Learning 実践 (L200) | ハンズオン | 320分 |
| 17 | 参照アーキテクチャ | 座学 | 15分 |
| 18 | Appendix 3: データサイエンス・プロセス | 座学 | 10分 |
| 19 | Appendix 4: Microsoft 製品との連携 | 座学 | 10分 |
| 20 | クロージング | インタラクティブ | 10分 |
...
| [3](./doc/agenda/DAY3.md) | モジュール No.16 - 20 | 約7時間(425分) (380分:45分) |
