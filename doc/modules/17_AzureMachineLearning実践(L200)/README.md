...
| 4 | 自動機械学習 Automated Machine Learning による品質管理モデリング & モデル解釈 (リモート高速実行) | 分類 | [Factory.csv](./assets/data/Factory.csv) | https://github.com/konabuta/Automated-ML-Workshop/blob/master/Sample/Azure-Machine-Learning/FactoryQC-classification-explainer-remote.ipynb |
