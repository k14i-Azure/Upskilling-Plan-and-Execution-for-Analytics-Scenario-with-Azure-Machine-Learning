...
### 問10. 未知の入力データに対する機械学習モデルの性能のことを【　　】という。(穴埋め)
...
### 問24. 半構造化データと呼ばれるものには、【(a)TSV (b)JSON (c)ソースコード】がある。(択一)
...
### 問25. 教師あり学習のベストプラクティスの一つは、用意したデータをすべて教師データに割り当てることでモデルの性能を高めることである。(y/n)
